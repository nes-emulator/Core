...
class ControlerCPUTests(unittest.TestCase):
    ...
    def test_ctl_load(self):
        ...
        self.assertEqual(0b10101010, self.memory.retrieve_content(Controllers.CTRL1_ADDR))
        self.assertEqual(0b11111111, self.memory.retrieve_content(Controllers.CTRL2_ADDR))
