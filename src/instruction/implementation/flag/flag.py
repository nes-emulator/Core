...
class SEC(Instruction):
    def __init__(self):
        super().__init__(opcode=56, cycles=2)
...
class CLI(Instruction):
    def __init__(self):
        super().__init__(opcode=88, cycles=2)
...
class SEI(Instruction):
    def __init__(self):
        super().__init__(opcode=120, cycles=2)
...
class CLV(Instruction):
    def __init__(self):
        super().__init__(opcode=184, cycles=2)
...
class CLD(Instruction):
    def __init__(self):
        super().__init__(opcode=216, cycles=2)
...
class SED(Instruction):
    def __init__(self):
        super().__init__(opcode=248, cycles=2)
